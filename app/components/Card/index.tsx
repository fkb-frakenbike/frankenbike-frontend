...
export default function CardComponent({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full ${variant === 'cardcolor' ? 'mt-4' : 'mt-2'} ${variant === 'cardcolor' ? 'h-28 sm:h-36 md:h-40' : 'h-32 sm:h-40 md:h-48'} ${variant === 'purpleCard' ? 'px-3 sm:px-4 md:px-6' : ''} `}
      >
        <img src={img} alt={title} className="h-full w-full rounded-[30px] object-cover" />
      </div>
